...
phases <- c("Movement Cue", "Full Movement","Before Movement", "Early Movement", "Half Movement", "Late Movement", "After Movement")
vps <- c("P")
```
...
rawData %>%
  select(sbjN, condN, BLOCK, trialN, flipped.gain, Target_length, resp, 
         C3_full, C4_full, C3_early, C4_early, C3_late, C4_late) %>%
